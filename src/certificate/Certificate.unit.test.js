...
test('Hash certificate', async () => {
  ...
  expect(await certificate.hash()).toBe('zEFPwEQxeKue1/l5wC0EhfBfbIPowrm6tSv1vOqfIp0=')
  expect(certificate.getHash()).toBe('zEFPwEQxeKue1/l5wC0EhfBfbIPowrm6tSv1vOqfIp0=')
})
